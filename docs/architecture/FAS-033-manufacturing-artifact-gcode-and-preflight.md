...
provided validation checks, preserves malformed metadata as review findings,
rejects symbolic-link inputs, and always requires user review. It does not
slice, upload, start, or authorize physical work.
