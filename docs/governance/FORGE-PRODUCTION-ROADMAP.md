...
not assign a new FAS number or change the canonical ledger. FAS-029 is now the
...
6. Phase A and the implemented portion of Phase B through FAS-026 are complete
   as tested reference contracts. FAS-029 is the next canonical specification
